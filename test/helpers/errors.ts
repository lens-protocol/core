export const ERRORS = {
  ...
  SUPER_TOKEN_TRANSFER_EXCEEDS_BALANCE: 'SuperfluidToken: move amount exceeds balance',
  SUPER_TOKEN_TRANSFER_EXCEEDS_ALLOWANCE: 'SuperToken: transfer amount exceeds allowance',
  NO_SELECTOR:
