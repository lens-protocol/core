export const ERRORS = {
  ...
  CALLER_NOT_WHITELSITED_MODULE: 'CallerNotAllowlistedModule()',
  NOT_GOVERNANCE: 'NotGovernance()',
  COLLECT_MODULE_NOT_ALLOWLISTED: 'CollectModuleNotAllowlisted()',
  FOLLOW_MODULE_NOT_ALLOWLISTED: 'FollowModuleNotAllowlisted()',
  REFERENCE_MODULE_NOT_ALLOWLISTED: 'ReferenceModuleNotAllowlisted()',
  PROFILE_CREATOR_NOT_ALLOWLISTED: 'ProfileCreatorNotAllowlisted()',
